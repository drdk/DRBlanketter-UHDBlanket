...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44261535004593015)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44261884440593015)
,p_plug_template_id=>wwv_flow_api.id(44261535004593015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44262112722593015)
,p_plug_template_id=>wwv_flow_api.id(44261535004593015)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44262407446593015)
,p_plug_template_id=>wwv_flow_api.id(44261535004593015)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44262710384593015)
,p_plug_template_id=>wwv_flow_api.id(44261535004593015)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44263008208593015)
,p_plug_template_id=>wwv_flow_api.id(44261535004593015)
