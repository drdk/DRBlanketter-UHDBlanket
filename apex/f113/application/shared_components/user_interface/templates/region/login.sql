...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44242198150593007)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44242497012593007)
,p_plug_template_id=>wwv_flow_api.id(44242198150593007)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44242774916593007)
,p_plug_template_id=>wwv_flow_api.id(44242198150593007)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44243097672593007)
,p_plug_template_id=>wwv_flow_api.id(44242198150593007)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44243356744593007)
,p_plug_template_id=>wwv_flow_api.id(44242198150593007)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44243620110593007)
,p_plug_template_id=>wwv_flow_api.id(44242198150593007)
,p_name=>'Sub Regions'
