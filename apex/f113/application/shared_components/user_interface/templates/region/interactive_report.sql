...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44240323821593006)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44240631624593006)
,p_plug_template_id=>wwv_flow_api.id(44240323821593006)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44240919269593006)
,p_plug_template_id=>wwv_flow_api.id(44240323821593006)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44241224384593006)
,p_plug_template_id=>wwv_flow_api.id(44240323821593006)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44241530311593006)
,p_plug_template_id=>wwv_flow_api.id(44240323821593006)
,p_name=>'Sub Regions'
