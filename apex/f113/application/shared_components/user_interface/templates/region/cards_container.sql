...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44197378526592987)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44197657867592987)
,p_plug_template_id=>wwv_flow_api.id(44197378526592987)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44197904677592987)
,p_plug_template_id=>wwv_flow_api.id(44197378526592987)
,p_name=>'Sub Regions'
