...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44218300269592996)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44218632935592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44218971364592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44219227129592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44219512074592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44219885947592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44220110576592997)
,p_plug_template_id=>wwv_flow_api.id(44218300269592996)
,p_name=>'Sub Regions'
