...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44222595141592998)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44222869133592998)
,p_plug_template_id=>wwv_flow_api.id(44222595141592998)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44223159139592998)
,p_plug_template_id=>wwv_flow_api.id(44222595141592998)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44223452007592998)
,p_plug_template_id=>wwv_flow_api.id(44222595141592998)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44223765799592999)
,p_plug_template_id=>wwv_flow_api.id(44222595141592998)
,p_name=>'Sub Regions'
