...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(44254138447593012)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44254437295593012)
,p_plug_template_id=>wwv_flow_api.id(44254138447593012)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(44254782348593012)
,p_plug_template_id=>wwv_flow_api.id(44254138447593012)
,p_name=>'Tabs'
